...
//At cell 3n+3
{
    ...
    //go to the bit cell, set it to zero
    "<-"
    
    //if the one is left end, remove one bit at the left
    {
        //go to the boundary cell of the left bit
        "<<<<"
        //copy it the bit cell and aux bit cell
        "[->>>>+>+<<<<<]"
        
        //go to the boundary cell of the left bit
        //the boundary cell of the left bit is NOT gate of the bit cell
        "+>>>>[-<<<<->>>>]<<<<"
        
        {
            //if the boundary cell of the left bit is true, this means it is left end
            "[-"
        ...
        ">>>>>"
        //copy it to the boundary cell of the left bit
        "[-<<<<<+>>>>>]"
    }
