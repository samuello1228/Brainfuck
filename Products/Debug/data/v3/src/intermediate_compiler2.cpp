...
//changes: exchange the cells 58-60 and 55-57 (cannot run)
//changes: replace "the case that the input character is not line comment and inside quote" by "the case that the function name is read"
