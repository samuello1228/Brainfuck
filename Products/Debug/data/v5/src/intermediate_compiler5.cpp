...
//changes: use function 01 for the rest
...
//while(input)
{
    ...
    //check whether the input is 0
    {
        ...
        
        {
            ...
            
            {
                ...
                {
                    //go to aux bool cell 91 (add 67) (1000011)
                    "01 > 1100001"
                ...
                //change to the case that the function name is read
                {
                    //go to aux bool cell 59 (minus 35) (100011)
                    "01 < 110001"
    ...
    //identify the file name
    {
        ...
        {
            //go to bool cell of temp variable (cell 91) (add 33) (100001)
            "01 > 100001"
        ...
        {
            {
                //go to input (cell 49) (minus 42) (101010)
                "01 < 010101"
    ...
    //For function 1: run the code in the first argument
    {
        ...
        //go to aux bool cell 102 (add 41) (101001)
        "01 > 100101"
        //set it to true
        "1 +"
    ...
    //For function 01: run a single code, for n times, e.g. "01 + 111"
    {
        ...
        //For the case that the first argument is read
        {
            ...
            //copy cell 50 to cell 109
            {
                ...
                //go to cell 109 (add 58) (111010)
                "01 > 010111"
                "1 +"
                
                //go to cell 50 (minus 59) (111011)
                "01 < 110111"
                "1 ]"
        ...
        //check whether the input is 0
        {
            ...
            
            {
                ...
                
                {
                    ...
                    //change to the case that the second argument is read
                    {
                        //go to aux bool cell 65 (minus 29) (11101)
                        "01 < 10111"
                        //set it to true
                        "1 +"
                        //change to the case that the second argument is read
                ...
                
                {
                    ...
                    //set the temp variable (add bit 1)
                    {
                        //go to aux bool cell 91 (add 69) (1000101)
                        "01 > 1010001"
        ...
        //For running
        {
            ...
            //output n times
            {
                //go to bool cell of temp variable (cell 91) (add 24) (11000)
                "01 > 00011"
                ...
                //go to cell 109 (add 15) (1111)
                "01 > 1111"
                
                //output
                "1 ."
                
                //go to bool cell of temp variable (cell 91) (minus 18) (10010)
                "01 < 01001"
                "1 ]"
            ...
            {
                //go to aux bool cell 69 (minus 40) (101000)
                "01 < 000101"
        ...
        //go to aux bool cell 105 (add 38) (100110)
        "01 > 011001"
        //set it to true
        "1 +"
    ...
    {
        //go to aux bool cell 69 (minus 34) (100010)
        "01 < 010001"
        //if cell 69 is true
        "1 ["
    ...
    //finalize the running
    {
        ...
        //go to aux bool cell 53 (minus 45) (101101)
        "01 < 101101"
        //set aux bool cell 53 to true
        "1 +"
        //change to the case that the input character is not line comment and outside quote
    ...
    //reset all bool cells
    {
        ...
        {
            //For function
            //go to aux cell 102 (add 34) (100010)
            "01 > 010001"
    ...
    {
        //go to input (cell 49) (minus 59) (111011)
        "01 < 110111"
        //clear
        "1 <<<[<<<]>>[-]>[->[-]>[-]>]<+>"
