...
//changes: new varible structure
//changes: move cell 95-108 to 166-179
//changes: use temp binary 3 for the input for function name
//changes: use temp binary 1 for the second argument for function 01
...
{
    //go to cell 51 (minus 128) (1111111 + 1)
    "01 < 1111111"
    "1 <"
    //get input
    "1 ,"
...
//while(input)
{
    ...
    //check whether the input is 0
    {
        ...
        
        {
            ...
            
            {
                ...
                {
                    //go to aux bool cell 162 (add 138) (1111111 + 1011)
                    "01 > 1111111"
                    "01 > 1101"
    ...
    //For function 01: run a single code, for n times, e.g. "01 + 111"
    {
        ...
        //For running
        {
            ...
            //output n times
            {
                ...
                //go to cell 109 (add 6) (110)
                "01 > 011"
                
                //output
                "1 ."
                
                //go to bool cell of temp binary 1 (cell 100) (minus 9) (1001)
                "01 < 1001"
                "1 ]"
                
                //go to cell 109 (add 9) (1001)
                "01 > 1001"
                //clear cell 109
                "1 [-]"
            }
    ...
    {
        //go to aux bool cell 69 (minus 105) (1101001)
        "01 < 1001011"
        //if cell 69 is true
        "1 ["
    ...
    {
        //go to input (cell 49) (minus 130) (1111111 + 11)
        "01 < 1111111"
        "01 < 11"
        //clear
        "1 <<<[<<<]>>[-]>[->[-]>[-]>]<+>"
