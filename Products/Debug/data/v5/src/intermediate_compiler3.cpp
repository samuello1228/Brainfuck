...
//changes: use function 01 for aux bool cell inside the if-else block
...
//while(input)
{
    ...
    {
        //go to function 1 (cell 100) (add 34)
        "1 >>>>>>>>>>"
        "1 >>>>>>>>>>"
        "1 >>>>>>>>>>"
        "1 >>>>"
    ...
    //For function 01: run a single code, for n times, e.g. "01 + 111"
    {
        ...
        //For running
        {
            ...
            {
                //go to aux bool cell 69 (minus 40)
                "1 <<<<<<<<<<"
                "1 <<<<<<<<<<"
                "1 <<<<<<<<<<"
                "1 <<<<<<<<<<"
        ...
        //go to aux bool cell 105 (add 38)
        "1 >>>>>>>>>>"
        "1 >>>>>>>>>>"
        "1 >>>>>>>>>>"
        "1 >>>>>>>>"
    ...
    {
        //go to aux bool cell 69 (minus 34)
        "1 <<<<<<<<<<"
        "1 <<<<<<<<<<"
        "1 <<<<<<<<<<"
        "1 <<<<"
    ...
    //finalize the running
    {
        ...
        //go to aux bool cell 53 (minus 45)
        "1 <<<<<<<<<<"
        "1 <<<<<<<<<<"
        "1 <<<<<<<<<<"
        "1 <<<<<<<<<<"
