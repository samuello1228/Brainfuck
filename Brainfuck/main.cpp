...
int main()
{
    ...
    */
    ...
    Run("data/v4/bin/next_compiler.txt","data/v5/src/intermediate_compiler7.cpp","data/v5/bin/intermediate_compiler7.txt");
    Run("data/v5/bin/intermediate_compiler7.txt","data/v5/src/intermediate_compiler5.cpp","data/v5/bin/intermediate_compiler5.txt");
